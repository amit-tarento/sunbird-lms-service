...
public class OnRequestHandler implements ActionCreator {
  ...
  public static String custodianOrgHashTagId;
  ...
  public void initializeRequestInfo(Http.Request request, String userId, String requestId) {
    try {
      ...
      Map<String, Object> telemetryContext = new WeakHashMap<>();
      telemetryContext.putAll(reqContext);
      telemetryContext.put("telemetry_pdata_id", getContextValue("telemetry_pdata_id"));
      telemetryContext.put("telemetry_pdata_pid", getContextValue("telemetry_pdata_pid"));
      telemetryContext.put("telemetry_pdata_ver", getContextValue("telemetry_pdata_ver"));
